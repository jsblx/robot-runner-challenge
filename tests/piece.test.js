...
# Last Modified time: 2019-10-10 00:38:35
# ---------------------------------------------
# ---------------------------------------------*/
...
it('sets coordinates as (1,4)', () => {
  ...
  expect(piece.getCoordinates()).toEqual({ row: 1, col: 4 });
  expect(setCoordinateMock).toHaveBeenCalledTimes(1);
});
...
it('sets coordinates as (4,1)', () => {
  ...
  expect(piece.getCoordinates()).toEqual({ row: 4, col: 1 });
  expect(setCoordinateMock).toHaveBeenCalledTimes(1);
});


it('sets coordinates as (3,4), and moves north', () => {
  const piece = new BoardPiece(0, setCoordinateMock);
...
it('sets coordinates as (3,4), and moves south', () => {
  const piece = new BoardPiece(0, setCoordinateMock);
  piece.setCoordinates(3, 4);
  expect(piece.getCoordinates()).toEqual({ row: 3, col: 4 });
  expect(setCoordinateMock).toHaveBeenCalledTimes(1);
  ...
  piece.moveSouth();
  expect(piece.getCoordinates()).toEqual({ row: 2, col: 4 });
  expect(setCoordinateMock).toHaveBeenCalledTimes(2);
});

it('sets coordinates as (3,4), and moves east', () => {
  const piece = new BoardPiece(0, setCoordinateMock);
  piece.setCoordinates(3, 4);
  expect(piece.getCoordinates()).toEqual({ row: 3, col: 4 });
  expect(setCoordinateMock).toHaveBeenCalledTimes(1);
  ...
  piece.moveEast();
  expect(piece.getCoordinates()).toEqual({ row: 3, col: 5 });
  expect(setCoordinateMock).toHaveBeenCalledTimes(2);
});
